...
void sensors(void)
{
	...
	float temp_range = 25.0;
	float moist_range = 25.0;
...
//	if (temperature_reading < temp_range  && moisture < moist_range)
//	{	/*
//		LPC_GPIO1->FIOSET |= relay_pin;
//		lcd_str_write("RELAY ON");
//		uart_str("RELAY ON");
//  		uart_str("\r\n");
//		delay(5000);    //Relay will turn ON for 5 sec
//		*/
//		uart_str("RELAY IS ON\r\n");       // Send a message through UART
//	    lcd_cmd_write(0x01);
//	    lcd_cmd_write(0x80);
//	    lcd_str_write("RELAY IS ON1");
//		delay(10);
//		lcd_cmd_write(0x01);
//		LPC_GPIO0->FIOSET |= relay_pin;
//	}
	...
	else if (temperature_reading > temp_range  && moisture < moist_range)
	{
		LPC_GPIO1->FIOSET |= relay_pin;
		lcd_str_write("RELAY ON");
		uart_str("RELAY ON");
  		uart_str("\r\n");	
		delay(10000);    //Relay will turn ON for 10 sec
	}
